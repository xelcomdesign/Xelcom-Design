...
<a href="LOGO" class="btn btn-info">Plus Logos</a>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="search-result bg-gray">
					<h2>Résultats pour "Logo"</h2>
					<div class="profile-thumb">
							<img src="{{asset('images/products/user.JPG')}}" alt="" class="rounded-circle">
	...
	<div class="card">
		<div class="thumb-content">
			<a href="{{route('realisation')}}">
				<img class="product-item " src="{{asset('images/products/cocotex.png')}}" alt="LOGO">
            </a>
...
<div class="card-body">
     ...
     <div class="card">
         <div class="thumb-content">
             <a href="{{route('realisation')}}">
                 <img class="product-item " src="{{asset('images/products/PLG.png')}}" alt="LOGO">
             </a>
         </div>
     ...
     <div class="card">
         <div class="thumb-content">
             <a href="{{route('realisation')}}">
                 <img class="product-item " src="{{asset('images/products/CDS-01.png')}}" alt="LOGO">
             </a>
         </div>
     ...
     <div class="card">
         <div class="thumb-content">
             <a href="{{route('realisation')}}">
                 <img class="product-item " src="{{asset('images/products/new logo-01.png')}}" alt="LOGO">
             </a>
         </div>
     ...
     <div class="card">
         <div class="thumb-content">
             <a href="{{route('realisation')}}">
                 <img class="product-item " src="{{asset('images/products/UCDD-01.png')}}" alt="LOGO">
             </a>
         </div>
     ...
     <div class="card">
         <div class="thumb-content">
             <a href="{{route('realisation')}}">
                 <img class="product-item " src="{{asset('images/products/Bokoo car-01.jpg')}}" alt="LOGO">
             </a>
         </div>
     ...
     <div class="card">
         <div class="thumb-content">
             <a href="{{route('realisation')}}">
                 <img class="product-item " src="{{asset('images/products/SOFT-01.png')}}" alt="LOGO">
             </a>
         </div>
