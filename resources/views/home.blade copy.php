...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="">
				<img class="card-img-top img-fluid" src="images/products/800.jpeg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="">
				<img class="card-img-top img-fluid" src="images/products/801.jpeg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="">Carte de Visite</a></h4>
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="">
				<img class="card-img-top img-fluid" src="images/products/802.jpeg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="">Carte de Visite</a></h4>
